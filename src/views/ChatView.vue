<template>
  ...
  <!--<div class="flex absolute h-screen w-14 right-0 z-10 bg-midnight-blue"></div>

  <section class="flex absolute -right-48">
    <section class="w-64 h-screen bg-dragon-purple transition-transform duration-300" :class="{'-translate-x-60': userInfo}">
      <button
        @click="viewProfile"
  ...
  <div class="absolute flex -right-60">
    <section class="flex">
      <section class="w-64 h-screen bg-dragon-purple transition-transform duration-300" :class="{'-translate-x-60': userInfo}">
        <button
          @click="viewProfile"
    ...
    <div class="h-screen w-14 z-10 bg-midnight-blue -translate-x-60"></div>
  </div>
...
export default {
  ...
  setup() {
    ...
    return { messages, messageContainer, toolBox, addMessage, viewTools, userInfo, viewProfile, profile };
