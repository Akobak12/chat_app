<template>
  <div class="flex justify-end w-full h-12 py-1 bg-midnight-blue border-l-8 border-clay-purple">
    <input 
    ...
    <button @click="sendMessage" class="h-full mx-5">
        <img src="../../assets/buttons/submit.png" class="h-full object-contain">
    </button>
  </div>
</template>
